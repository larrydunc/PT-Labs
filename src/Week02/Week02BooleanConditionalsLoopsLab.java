...
public class Week02BooleanConditionalsLoopsLab {
	...
	public static void main(String[] args) {
		...
		int numberOfCookies = 37;
		int numberOfChildren = 39;
		int cookiesLeftOver = numberOfCookies % numberOfChildren;
		
		if (cookiesLeftOver == 0) {
			System.out.println("Sad Face");
			} else if (cookiesLeftOver < 2) {
				System.out.println("Yes!");
			} else if (cookiesLeftOver < 5) {
